...
const industryBriefTemplates = {
  "食品": "食品・飲料や加工食品を展開。価格改定、原材料費、販売数量が見どころ。",
  "エネルギー資源": "資源開発や燃料販売を展開。資源価格、為替、需給環境の影響を受けやすい。",
  "建設・資材": "建設、土木、住宅、建材を展開。受注残、資材価格、人件費が焦点。",
  "素材・化学": "化学品や産業素材を供給。市況、原燃料価格、稼働率が収益を左右しやすい。",
  "医薬品": "医薬品や医療関連製品を展開。新薬開発、薬価、特許、海外販売が焦点。",
  "自動車・輸送機": "完成車、部品、輸送機器を手がける。生産台数、為替、電動化投資が見どころ。",
  "鉄鋼・非鉄": "鉄鋼・非鉄金属など産業素材を供給。金属市況とエネルギーコストが重要。",
  "機械": "産業機械や設備機器を展開。受注動向と地域別需要が焦点。",
  "電機・精密": "電子機器、精密機器、半導体関連を展開。半導体サイクルと部材需給が注目点。",
  "情報通信・サービスその他": "IT、通信、メディア、人材、広告、各種サービスを展開。利用者数や契約単価が焦点。",
  "電力・ガス": "電力・ガスなどエネルギー供給を担う。燃料費、需要、設備投資が重要。",
  "運輸・物流": "鉄道、陸運、海運、空運、倉庫を展開。輸送量、運賃、燃料費が業績に効きやすい。",
  "商社・卸売": "卸売、トレーディング、事業投資を展開。市況、投資先利益、在庫評価が見どころ。",
  "小売": "店舗やECで消費者向けに販売。既存店売上、客数、客単価、在庫が焦点。",
  "銀行": "預金、貸出、決済などを展開。金利、貸出残高、利ざや、与信費用が重要。",
  "金融（除く銀行）": "証券、保険、リース、カード、投資を展開。市場環境と信用コストが焦点。",
  "不動産": "不動産の開発、賃貸、管理、仲介を展開。売却益、賃料、空室率、金利が見どころ。"
};
